    ...
    <div class="footer-top">
        ...
        <div class="footer-brand">
            ...
            <div class="footer-socials">
                ...
                {{-- YouTube --}}
                <a href="https://youtu.be/05rnFy_1JwE?si=qiyrqGXXkkF_C5L3" class="footer-social-link" aria-label="YouTube" target="_blank" rel="noopener noreferrer">
        ...
        <div class="demo-modal-dialog" role="dialog" aria-modal="true" aria-label="Video Demo SoftiFy">
            ...
            <div class="demo-modal-content">
                <iframe 
                    ...
                    height="600" 
                    src="about:blank"
                    data-src="https://www.youtube.com/embed/05rnFy_1JwE?autoplay=1&amp;loop=1&amp;playlist=05rnFy_1JwE" 
